...
public:
    ...
    //  float w2;                                //测试S弯角速度
     ...
     bool goal_approaching;
     bool force_back_to_origin;
     ...
     void cvmode_callback(const std_msgs::Int16::ConstPtr &msg);
     //void amcl_calib_callback(const std_msgs::UInt8::ConstPtr &msg);
};
